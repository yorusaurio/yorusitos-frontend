...
let contacts: AdminContact[] = [
  { id: "SUP-201", name: "Andrea M.", channel: "WhatsApp", issue: "Consulta de talla", priority: "Media", status: "Abierto" },
  { id: "SUP-200", name: "Pedro G.", channel: "Email", issue: "Cambio por defecto", priority: "Alta", status: "En proceso" },
  { id: "SUP-199", name: "Tienda Miraflores", channel: "Formulario", issue: "Pedido mayorista", priority: "Alta", status: "Abierto" },
];
